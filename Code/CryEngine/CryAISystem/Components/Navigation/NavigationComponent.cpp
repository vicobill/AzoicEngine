// Copyright 2017-2022 Crytek GmbH / Crytek Group. All rights reserved.
...
{
	const bool isSuccess = result.result == MovementRequestResult::Success;
	...
	{
		m_navigationCompletedCallback(isSuccess);
	}
}
