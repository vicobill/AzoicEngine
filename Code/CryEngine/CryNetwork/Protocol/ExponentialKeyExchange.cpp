...
{
	DIGIT_T sh[2] = { 4196051798, 2691265849 };
	mpShiftRight(sh, sh, 0, 2);
	if (sh[0] != 4196051798 || sh[1] != 2691265849)
	{
		CryFatalError("mpShiftRight is broken. Make sure the variable 'mask' is volatile or optimization is disabled for bigdigits.");
	}
