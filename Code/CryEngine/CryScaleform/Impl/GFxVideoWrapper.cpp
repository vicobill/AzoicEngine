...
static float s_sys_flash_video_buffertime = 15.0f;
static float s_sys_flash_video_buffertime_loading = 15.0f;
...
private:
	...
	{
		if (gEnv && gEnv->pSystem && m_sIsRegistered)
			gEnv->pSystem->GetISystemEventDispatcher()->RemoveListener(this);
	}

private:
	static bool m_sIsRegistered;
	EState m_eLoadingState;
};

bool CryGFxVideoPlayer_SystemEventListener::m_sIsRegistered = false;
