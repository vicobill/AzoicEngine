...
void CSystem::ShutDown()
{
	...
	// Proper hierarchical destruction requires a refactor
	UnloadEngineModule("CryScaleformD3D11");
	UnloadEngineModule("CryScaleformD3D12");
	UnloadEngineModule("CryScaleformVulkan");
	UnloadEngineModule("CryScaleformGNM");
#endif
