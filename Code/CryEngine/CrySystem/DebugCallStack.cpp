...
bool CCrashRpt::InstallHandler()
{
	...
	info.uPriorities[CR_HTTP] = 1;  // Prioritize HTTP
	info.uPriorities[CR_SMTP] = CR_NEGATIVE_PRIORITY;  // Do not use SMTP
	info.uPriorities[CR_SMAPI] = CR_NEGATIVE_PRIORITY; // Do not use Simple MAPI
