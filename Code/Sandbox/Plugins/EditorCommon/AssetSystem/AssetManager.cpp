...
void CAssetManager::Init(bool isAsync)
{
...
void CAssetManager::AsyncScanForAssets()
{
	...
	auto mergeAssets = [this](const std::vector<CAsset*>& assets)
	{
	...
	AssetLoaderBackgroundTask::RunAsync(paths, mergeAssets);
}
...
void CAssetManager::ScanForAssets()
{
	...
	AssetLoaderBackgroundTask::Run(paths, mergeAssets);
}
