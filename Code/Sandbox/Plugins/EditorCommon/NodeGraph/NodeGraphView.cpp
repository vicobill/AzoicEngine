...
{
	// Get widget item via model directly
	if (auto pConnectionWidget = GetConnectionWidget(connection))
	{
		if (QGraphicsItem* pGraphicsItem = static_cast<QGraphicsItem*>(pConnectionWidget))
		{
			DeselectWidget(*pConnectionWidget);
