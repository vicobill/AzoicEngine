...
namespace Cry
{
	namespace GamePlatform
	{
		...
		public:
			...
			virtual IStreamInstall* GetStreamInstall() const override;
		...
		private:
			...
			size_t FindNumberOfLoggedInServices() const;
			void AddAccounts() const;
		...
		private:
			...
			mutable size_t m_loggedInServices = 0;
		};
	}
}
