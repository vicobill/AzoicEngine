...
#define CRYSESSION_CREATE_FLAG_SEARCHABLE 0x00000001                   //!< If set the session will be searchable and returned in session searches. If set, uses "uses matchmaking" flag on live; if not set uses "hidden" flag on NP.
