// Copyright 2009-2022 Crytek GmbH / Crytek Group. All rights reserved.
#pragma once
...
//! [in] = maximum size of the buffer pre-allocated
...
//
// PS3 ONLY
// 'PCom'    void*    ptr to static Orbis Communitcation ID structure (not copied - DO NOT PLACE ON STACK!)
// 'PPas'    void*    ptr to static Orbis Communication Passphrase structure (not copied - DO NOT PLACE ON STACK!)
// 'PSig'    void*    ptr to static Orbis Communication Signature structure (not copied - DO NOT PLACE ON STACK!)
...
// 'PTit'    void*    ptr to static Orbis Title ID structure           (not copied - DO NOT PLACE ON STACK!)
// 'PSec'    void*    ptr to static Orbis Title Secret Data structure  (not copied - DO NOT PLACE ON STACK!)
