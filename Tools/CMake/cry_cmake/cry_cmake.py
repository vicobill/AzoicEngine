...
class Application(tk.Frame):
    ...
    config_path = os.path.expandvars(r'%APPDATA%\Crytek\CryENGINE')
    ...
    def create_widgets(self):
        ...
        i = 0
        try:
            with open(os.path.join(self.config_path, r'cry_cmake.cfg'), 'r') as f:
                last_choice = f.read()
            for c in CONFIGS:
    ...
    def generate_cmd(self):
        try:
            ...
            with open(os.path.join(self.config_path, r'cry_cmake.cfg'), 'w') as f:
            ...
            tk.messagebox.showerror("Error", "An error occured:\r\n{}".format(e))
