...
macro(deploy_pyside)
	set(PYSIDE_SDK_SOURCE "${QT_DEPLOY_ROOT}/PySide2/")
	set(PYSIDE_SOURCE "${PYSIDE_SDK_SOURCE}")
...
macro(copy_binary_files_to_target)
	...
	if (WINDOWS)
		...
		if (OPTION_SANDBOX)
			...
			deploy_runtime_files("${QT_DEPLOY_ROOT}/PySide2/qt.conf" "")
			deploy_runtime_files("${QT_DEPLOY_ROOT}/PySide2/shiboken2.cp37-win_amd64.pyd" "")
