if (EXISTS "${CRYENGINE_DIR}/Code/CryEngine/Cry3DEngine")
    if (NOT PROJECT_BUILD)
        set(OPTION_ENGINE ON CACHE BOOL "Build CRYENGINE")
    else()
        set(OPTION_ENGINE OFF CACHE BOOL "Build CRYENGINE")
    endif()
else()
    set(OPTION_ENGINE OFF)
endif()
